# Graph Report - /Users/louissamake/Documents/Nka Bulletin  (2026-07-26)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 405 nodes · 580 edges · 25 communities (23 shown, 2 thin omitted)
...
Cohesion: 0.09
Nodes (7): SecureStorageManager, GoogleAuthManager, AuthModule, Context, GoogleAccountCredential, MasterKey, SharedPreferences
...
Cohesion: 0.32
Nodes (3): Result, MicrosoftAuthManager, IMultipleAccountPublicClientApplication
...
## Knowledge Gaps
- **13 isolated node(s):** `MailModule`, `GMAIL`, `OUTLOOK`, `IMAP`, `PDF_MERGE` (+8 more)
